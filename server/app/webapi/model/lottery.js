...
var _class = function (_think$model$relation) {
    ...
    _class.prototype.getCurrentLottery = function () {
        var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(ownerId) {
            var currentLotteryInfo;
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return this.where({ 'owner': ownerId }).select();

                        case 2:
                            currentLotteryInfo = _context.sent;
                            return _context.abrupt('return', currentLotteryInfo);
        ...
        function getCurrentLottery(_x) {
            return _ref.apply(this, arguments);
        }

        return getCurrentLottery;
    }();
